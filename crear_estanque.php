...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Añadir estanques
        <small>Agregue nuevas estanques para gestionar los cultivos</small>
      </h1>
    </section>
            ...
            <section class="content">
                ...
                <div class="box">
                  <div class="box-header with-border">
                    <h3 class="box-title">Añadir estanque</h3>
                  </div>
                  <div class="box-body">
                      <form role="form" name="guardar-registro" id="guardar-registro" method="post" action="modelo-estanque.php">
                        <div class="box-body">
                          <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nombre_estanque" name="nombre_estanque" placeholder="Nombre del estanque" autocomplete="off" required>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <input type="number" class="form-control" id="profundidad" name="profundidad" step="any" min="1" max="10000" autocomplete="off" required>
                          </div>
                          <div class="form-group">
                            <label for="l_may_r" id="label_ch">Longitud mayor (cm): </label>
                            <input type="number" class="form-control" id="l_may_r" name="l_may_r" step="any" min="1" max="10000" autocomplete="off" required>
                          ...
                          <div class="form-group" id="div_lmen">
                            ...
                            <input type="number" class="form-control" id="l_men" name="l_men" step="any" min="0" max="10000" value="1.00" autocomplete="off" required>
